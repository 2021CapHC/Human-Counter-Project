...
file = open("/home/pi/Desktop/FinalCodesHumanCounter/DOUBLEDOORentryLEFTData.txt", "a")
...
#######Checks UltraSonicSesnor Distance for Sensor 2 (Outter)
    ...
    #time.sleep(0.01) #Short delay so no signals between sensors can cause errors
...
###### OBJECT ENTERING IN THE SYSTEM
    if distance1 > 1 and distance1 <= 27:
...
#IF SENSOR 1 DETECTS MAKESURE OBJECT WALKS PAST SENSOR 2 AS WELL
                ...
                distance2=distance2/2.54
                   #print("     distance2 INCH:",distance2,"in")
            #^^^^^^^Uncomment if you would like to see Distance Readings for USsensor2
                if distance2 > 1 and distance2 <= 27: #IF DETECTION @ SENSOR 2 THAN OBJECT WALKED IN FULLY
                     currentState2 = 1;
                     print( "LEFT DOOR : In Detected", currentState1) 
...
##PRINT########PRINT########PRINT########PRINT########PRINT########PRINT########PRINT########PRINT######
                     ...
                     print(" LEFT distance1 INCH:",distance1,"in")
                     time.sleep(0.4)
                     ...
                     if DoubleCheck == 8: #IF OBJECT DOES NOT WALK IN AFTER 6 CHECKS RETURN TO BEGINING OF PROGRAM
...
###### OBJECT EXITING OUT THE SYSTEM
    if distance2 > 1 and distance2 <= 27:
...
#IF SENSOR 2 DETECTS MAKESURE OBJECT WALKS PAST SENSOR 1 AS WELL
            ...
            #    print("     distance1 INCH:",distance1,"in")
    #^^^^^^^Uncomment if you would like to see Distance Readings for USsensor2
                if distance1 > 1 and distance1 <= 27: #IF DETECTION @ SENSOR 1 THAN OBJECT WALKED OUT FULLY
                     currentState1 = 1;
                     print( "LEFT DOOR: Out Detected", currentState2)                
...
##PRINT########PRINT########PRINT########PRINT########PRINT########PRINT########PRINT########PRINT######
                     print("   Inside:",inside,"   Outside:",outside)
                     print("   Counter:",counter)
                     print(" LEFT distance2 INCH:",distance2,"in")
                     time.sleep(0.4)
                     ...
                     currentState1 = 0;
                     DoubleCheck = DoubleCheck + 1 #SYSTEM WILL DOUBLE CHECK 6 TIMES FOR OBJECT TO PASS
                     if DoubleCheck == 8: #IF OBJECT DOES NOT WALK OUT AFTER 6 CHECKS RETURN TO BEGINING OF PROGRAM
